...
public class Car implements CarIF {
  ...
  /**
   * calculates the array priority for "this." Car from the standard arrangement: 1_"HANDICAPPED",
   * 2_"MOTORBIKE", 3_"E_VEHICLE", 4_"WOMEN", 5_"FAMILY", 6_"SUV", 7_"PKW", 8_"ANY"
   */
  @Override
  public void sortOutPriority() {
    if (params != null && params.length >= 8) {
      ...
      String[] s =
          new String[] {
            "HANDICAPPED", "MOTORBIKE", "E_VEHICLE", "WOMEN", "FAMILY", "SUV", "PKW", "ANY"
          };
