      ...
      case "getPrices":
        String prices =
            " price per minute day/night:€"
                + Math.round(
                        priceCalc.calcDayNightPrice(12 * 60 * 60 * 1000, 60 * 1000) / 100d * 100.0)
                    / 100.0
                + "/€"
                ...
                + Math.round(
                        priceCalc.calcDayNightPrice(12 * 60 * 60 * 1000, 60 * 60 * 1000)
                            / 100d
                            * 100.0)
                    / 100.0
                + "/€"
                ...
                + " | "
                + " price per 24 hours:€"
                + Math.round(priceCalc.calcDayNightPrice(0, 24 * 60 * 60 * 1000) / 100d * 100.0)
                    / 100.0
                + " | "
                + " price per month:€"
                + Math.round(
                        priceCalc.calcDayNightPrice(0, (30L * 24 * 60 * 60 * 1000)) / 100d * 100.0)
                    / 100.0
                + " | "
                + " price per year:€"
                + Math.round(
