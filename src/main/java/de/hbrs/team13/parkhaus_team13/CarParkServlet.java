...
public abstract class CarParkServlet extends HttpServlet {
    ...
    static ParkingGarage garage = new ParkingGarage(20);   //Stores vehicles currently parking in our garage
    static List<Consumer<UndoCommand>> undoList = new ArrayList<>();  //Undo-list to undo actions regarding entering and leaving
