...
public class StatisticsTest {
  ...
  void generateClientCategoryChart_2Cars_ShouldReturn50WomanAnd50Any() {
    assertEquals(
        "{\"data\":[{\"values\":[0.0,50.0,50.0,0.0],\"labels\":[\"FAMILY\",\"WOMEN\",\"ANY\",\"HANDICAPPED\"],\"type\":\"pie\"}]}",
  ...
  void generateVehicleTypeChart_2Cars_ShouldReturn50PkwAnd50EVehicle() {
    assertEquals(
        "{\"data\":[{\"values\":[0.0,50.0,0.0,50.0],\"labels\":[\"SUV\",\"PKW\",\"MOTORBIKE\",\"E_VEHICLE\"],\"type\":\"pie\"}]}",
  ...
  void generateDurationChart_2Cars_ShouldReturnDurationChart() {
    assertEquals(
        "{\"data\":[{\"x\":[11,12],\"y\":[99,130],\"type\":\"bar\",\"name\":\"Duration\"}]}",
