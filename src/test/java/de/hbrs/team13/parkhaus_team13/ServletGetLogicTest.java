...
class ServletGetLogicTest {
    ...
    void response_caseMinWithCar_expectsCorrectString(){
        expected="Car "+stats.getMin().getLicense()+" with "+stats.getMin().getDuration()+" seconds";
    ...
    void response_caseMaxWithCar_expectsCorrectSting(){
        expected="Car "+stats.getMax().getLicense()+" with "+stats.getMax().getDuration()+" seconds";
    ...
    void response_caseGetPrices_expectsCorrectString(){
        expected= " price per minute day/night:€" +
