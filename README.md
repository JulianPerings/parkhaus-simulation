...
```
cd existing_repo
git remote add origin https://vm-2d21.inf.h-brs.de/cfalke2s/parkhaus-simulatio-team-13.git
git branch -M main
...
- [ ] [Set up project integrations](https://vm-2d21.inf.h-brs.de/cfalke2s/parkhaus-simulatio-team-13/-/settings/integrations)
